CREATE DATABASE IF NOT EXISTS reservacion_hoteles;
USE reservacion_hoteles;
...
CREATE TABLE IF NOT EXISTS Huesped (
  idHuesped INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS Hotel (
  ...
  num_tel VARCHAR(45) NOT NULL,
  calificacion_estrellas INT CHECK (calificacion_estrellas BETWEEN 1 AND 5) NOT NULL
);

-- Tabla Reservacion
CREATE TABLE IF NOT EXISTS Reservacion (
  idReservacion INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS Habitacion (
  ...
  Reservacion_idReservacion INT DEFAULT NULL,
  Hotel_idHotel INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS Check_Out (
  idCheckOut INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
